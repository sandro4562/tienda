          ...
          <tbody class="card-body container">
            ...
            <?php if($usuarios){ foreach ($usuarios as $usu) { ?>
              <tr>
                ...
                <td><?= $usu->ci; ?></td>
                <td class="noPrint">
                  <a class="btn btn-info" href="/index.php/clienteController/editar/<?= $usu->id; ?>">Modificar</a>
                  <a class="btn btn-danger" href="/index.php/clienteController/borrar/<?= $usu->id; ?>">Eliminar</a>
                </td>
              </tr>
            <?php } } else { ?>
              <tr>
