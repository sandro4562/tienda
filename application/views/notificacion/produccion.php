...
<div class="col-md-12"">
  <div class="container">
        ...
        <table class="table" id="printTable" style="width: 100%;">
          <thead class="card-header">
            <tr class="text-center">
              ...
              <th style="width: 10%" class="noPrint">Acciones</th>
            </tr>
          </thead>
          <tbody>
    ...
    <div style="margin-top: 20px;">
      <button class="btn btn-primary col-md-3" onclick="printTableContent('printTable', 'Productos en produccion')"> Imprimir
      </button>
    </div>
  </div>
  <br>
